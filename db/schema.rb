...
ActiveRecord::Schema.define(version: 2020_01_22_115025) do
  ...
  create_table "dishes_restaurants", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "locations_restaurants", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "restaurant_id"
  ...
  create_table "pictures", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["imageble_type", "imageble_id"], name: "index_pictures_on_imageable_type_and_imageable_id"
  end
